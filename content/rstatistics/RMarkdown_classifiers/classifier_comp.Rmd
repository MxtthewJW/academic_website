...
## <centre> **Logistic regression** </center>
...
## <centre> **Kernal support vector machine** </center>
...
![Test set](NaiveBayesTrainSet.png)

### Visualising the test set results

![Test set](NaiveBayesTestSet.png)
